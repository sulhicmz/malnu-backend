...
- [ ] **No duplicate PRs for same issue** - check existing PRs before creating a new one
...
4. **For automated workflows**: Ensure that workflows check for existing PRs before creating new ones to avoid duplicates.
