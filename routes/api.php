...
use App\Http\Controllers\Extracurricular\ClubController;
use App\Http\Controllers\Extracurricular\ActivityController;
use App\Http\Controllers\Extracurricular\MembershipController;
use App\Http\Controllers\Extracurricular\AdvisorController;
...
// Extracurricular Activity Management Routes (protected with role check)
Route::group(['middleware' => ['jwt', 'rate.limit', 'role:Super Admin|Kepala Sekolah|Staf TU|Guru']], function () {
    Route::prefix('clubs')->group(function () {
        // Club Management Routes
        Route::apiResource('clubs', ClubController::class);
        Route::get('clubs/{id}/statistics', [ClubController::class, 'statistics']);
        Route::get('clubs/upcoming', [ClubController::class, 'upcoming']);
        ...
        Route::get('students/{studentId}/memberships', [MembershipController::class, 'student']);
        ...
        Route::get('teachers/{teacherId}/advisories', [AdvisorController::class, 'teacher']);
    });
    
    Route::prefix('activities')->group(function () {
        // Activity Management Routes
        Route::apiResource('activities', ActivityController::class);
        Route::get('activities/{id}/attendance', [ActivityController::class, 'attendances']);
        Route::post('activities/{id}/mark-attendance', [ActivityController::class, 'markAttendance']);
        Route::get('activities/{id}/statistics', [ActivityController::class, 'statistics']);
    });
});
